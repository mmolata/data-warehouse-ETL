...
BEGIN 
	...
	total_time := total_time + duration;
	 ...
	 EXCEPTION
	        WHEN OTHERS THEN
	            RAISE NOTICE 'Failed to load silver.crm_cust_info. Error: %', SQLERRM;
	 END;
...
--insert cleaned crm_prd_info
	...
	EXCEPTION
		WHEN OTHERS THEN
	    RAISE NOTICE 'Failed to load silver.crm_prd_info. Error: %', SQLERRM;
	 END;
...
--insert cleaned crm_sales_details
	...
	EXCEPTION
	WHEN OTHERS THEN
	RAISE NOTICE 'Failed to load silver.crm_sales_details. Error: %', SQLERRM;
	END;
...
--insert cleaned erp_cust_az12
	...
	EXCEPTION
	WHEN OTHERS THEN
	RAISE NOTICE 'Failed to load silver.erp_cust_az12. Error: %', SQLERRM;
	END;
...
--insert cleaned erp_loc_a101
	...
	EXCEPTION
	WHEN OTHERS THEN
	RAISE NOTICE 'Failed to load silver.erp_loc_a101. Error: %', SQLERRM;
	END;
...
--insert cleaned erp_px_cat_g1v2
	...
	EXCEPTION
	WHEN OTHERS THEN
	RAISE NOTICE 'Failed to load silver.erp_px_cat_g1v2. Error: %', SQLERRM;
	END;
